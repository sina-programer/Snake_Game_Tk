...
class SettingDialog(BaseDialog):
    ...
    def body(self, frame):
        ...
        self.head_color_btn = tk.Button(frame, width=2, command=self.set_head_color,
        ...
        self.body_color_btn = tk.Button(frame, width=2, command=self.set_body_color,
        ...
        self.bg_color_btn = tk.Button(frame, width=2, command=self.set_bg_color,
